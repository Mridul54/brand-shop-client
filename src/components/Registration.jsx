...
const Registration = () => {
    ...
    const handleRegister = async (e) => {
        ...
        if (!specialCharRegex.test(password)) {
            setRgError('Password must contain at least one special character');
            return;
        }
        ...
        <div className='mt-10'>
            <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <form onSubmit={handleRegister} className="mt-6">
                    ...
                    <div>
                        <label htmlFor="username" className="block text-sm text-gray-800 dark:text-gray-200">Photo URL</label>
                        <input
                            type="text"
